      ...
      <div className={styles["container"]}> 
        <div className={styles['text_container']}>
          <div className={styles["description"]}>
              ...
              <br></br>
              <br></br>
              My name is Stephanie. I'm a 28 year-old junior frontend developer from Hamburg, Germany. 
              <br></br>
              <br></br>
              ...
              Ever since, I missed programming and now I'm back on track programming and constantly learning new things as a junior frontend developer.
